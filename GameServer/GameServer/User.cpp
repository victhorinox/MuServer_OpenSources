...
{
	//EXP Original (Level 400)
	if(gServerInfo.m_MaxUserLevel == 400)
	{
	...
	//EXP Custom (Level 1000)
	if(gServerInfo.m_MaxUserLevel == 1000)
	{
		gLevelExperience[0] = 0;
...
//	lpObj->AttackCustomOfflineMoneyDelay = 0;
	...
	lpObj->CashShopWCoinCTime = GetTickCount();
	lpObj->CashShopWCoinPTime = GetTickCount();
...
void gObjUserDie(LPOBJ lpObj,LPOBJ lpTarget) // OK
{
	...
	*/
	...
	if(gServerInfo.m_DieUserSwitch == 2 && lpObj->Type == OBJECT_USER && lpTarget->Type == OBJECT_USER)
	{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(515),lpTarget->Name,lpObj->Name);
	}
	if(gServerInfo.m_DieUserSwitch == 3 && lpObj->Type == OBJECT_USER && lpTarget->Type == OBJECT_USER)
	{
		if (lpObj->Map == MAP_LORENCIA)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(900),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DUNGEON)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(901),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DEVIAS)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(902),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NORIA)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(903),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_LOST_TOWER)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(904),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ARENA)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(905),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ATLANS)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(906),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_TARKAN)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(907),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DEVIL_SQUARE1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(908),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ICARUS)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(909),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(910),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(911),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE3)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(912),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE4)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(913),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE5)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(914),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE6)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(915),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE7)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(916),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(917),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(918),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE3)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(919),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE4)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(920),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE5)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(921),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE6)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(922),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(923),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(924),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA3)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(925),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA4)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(926),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA5)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(927),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA6)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(928),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CASTLE_SIEGE)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(929),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_LAND_OF_TRIALS)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(930),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DEVIL_SQUARE2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(931),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_AIDA)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(932),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CRYWOLF)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(933),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA7)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(934),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KANTURU1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(935),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KANTURU2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(936),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KANTURU3)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(937),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_SILENT)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(938),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BARRACKS)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(939),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_REFUGE)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(940),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(941),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(942),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE3)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(943),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE4)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(944),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE5)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(945),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE6)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(946),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ELBELAND)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(947),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE8)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(948),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE7)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(949),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_SWAMP_OF_CALMNESS)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(950),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_RAKLION1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(951),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_RAKLION2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(952),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_SANTA_TOWN)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(953),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_VULCANUS)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(954),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DUEL_ARENA)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(955),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DOUBLE_GOER1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(956),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DOUBLE_GOER2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(957),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DOUBLE_GOER3)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(958),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DOUBLE_GOER4)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(959),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_IMPERIAL_GUARDIAN1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(960),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_IMPERIAL_GUARDIAN2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(961),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_IMPERIAL_GUARDIAN3)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(962),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_IMPERIAL_GUARDIAN4)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(963),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_LOREN_MARKET)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(964),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KARUTAN1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(965),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KARUTAN2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(966),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ARKANIA)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(967),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NEWARENA)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(968),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ABUSS)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(969),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DUNES)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(970),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ACHERON)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(971),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMDOR)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(972),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NEW1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(973),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NEW2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(974),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NEW3)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(975),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ACHERON1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(976),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ACHERON2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(977),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NEW4)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(978),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NEW5)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(979),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DEVENTER1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(980),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DEVENTER2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(981),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE_FINAL)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(982),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE_FINAL1)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(983),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE_FINAL2)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(984),lpTarget->Name,lpObj->Name);
		}
	}
	if(gServerInfo.m_DieUserSwitch == 4 && lpObj->Type == OBJECT_USER && lpTarget->Type == OBJECT_USER)
	{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(515),lpTarget->Name,lpObj->Name);
	}
	if(gServerInfo.m_DieUserSwitch == 5 && lpObj->Type == OBJECT_USER && lpTarget->Type == OBJECT_USER)
	{
		if (lpObj->Map == MAP_LORENCIA)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(900),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DUNGEON)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(901),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DEVIAS)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(902),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NORIA)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(903),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_LOST_TOWER)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(904),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ARENA)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(905),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ATLANS)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(906),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_TARKAN)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(907),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DEVIL_SQUARE1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(908),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ICARUS)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(909),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(910),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(911),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE3)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(912),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE4)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(913),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE5)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(914),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE6)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(915),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE7)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(916),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(917),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(918),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE3)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(919),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE4)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(920),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE5)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(921),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE6)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(922),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(923),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(924),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA3)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(925),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA4)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(926),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA5)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(927),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA6)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(928),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CASTLE_SIEGE)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(929),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_LAND_OF_TRIALS)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(930),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DEVIL_SQUARE2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(931),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_AIDA)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(932),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CRYWOLF)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(933),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMA7)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(934),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KANTURU1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(935),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KANTURU2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(936),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KANTURU3)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(937),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_SILENT)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(938),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BARRACKS)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(939),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_REFUGE)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(940),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(941),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(942),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE3)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(943),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE4)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(944),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE5)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(945),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE6)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(946),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ELBELAND)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(947),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_BLOOD_CASTLE8)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(948),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE7)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(949),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_SWAMP_OF_CALMNESS)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(950),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_RAKLION1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(951),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_RAKLION2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(952),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_SANTA_TOWN)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(953),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_VULCANUS)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(954),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DUEL_ARENA)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(955),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DOUBLE_GOER1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(956),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DOUBLE_GOER2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(957),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DOUBLE_GOER3)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(958),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DOUBLE_GOER4)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(959),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_IMPERIAL_GUARDIAN1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(960),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_IMPERIAL_GUARDIAN2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(961),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_IMPERIAL_GUARDIAN3)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(962),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_IMPERIAL_GUARDIAN4)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(963),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_LOREN_MARKET)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(964),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KARUTAN1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(965),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KARUTAN2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(966),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ARKANIA)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(967),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NEWARENA)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(968),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ABUSS)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(969),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DUNES)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(970),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ACHERON)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(971),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_KALIMDOR)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(972),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NEW1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(973),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NEW2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(974),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NEW3)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(975),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ACHERON1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(976),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ACHERON2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(977),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NEW4)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(978),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_NEW5)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(979),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DEVENTER1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(980),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_DEVENTER2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(981),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_CHAOS_CASTLE_FINAL)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(982),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE_FINAL1)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(983),lpTarget->Name,lpObj->Name);
		}
		if (lpObj->Map == MAP_ILLUSION_TEMPLE_FINAL2)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(984),lpTarget->Name,lpObj->Name);
		}
	}
	//Die System Monster
	if(gServerInfo.m_DieMonsterSwitch == 1 && lpObj->Type == OBJECT_USER && lpTarget->Type == OBJECT_MONSTER)
	...
	if(gServerInfo.m_DieMonsterSwitch == 2 && lpObj->Type == OBJECT_USER && lpTarget->Type == OBJECT_MONSTER)
	{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(516),lpTarget->Name,lpObj->Name);
	}
	if(gServerInfo.m_DieMonsterSwitch == 3 && lpObj->Type == OBJECT_USER && lpTarget->Type == OBJECT_MONSTER)
	{
		if (lpObj->Map == MAP_LORENCIA)
		{
		gNotice.GCNoticeSendToAll(1,0,0,0,0,0,gMessage.GetMessage(900),lpTarget->Name,lpObj->Name);
	...
	if(gServerInfo.m_DieMonsterSwitch == 4 && lpObj->Type == OBJECT_USER && lpTarget->Type == OBJECT_MONSTER)
	{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(516),lpTarget->Name,lpObj->Name);
	}
		if(gServerInfo.m_DieMonsterSwitch == 5 && lpObj->Type == OBJECT_USER && lpTarget->Type == OBJECT_MONSTER)
	{
		if (lpObj->Map == MAP_LORENCIA)
		{
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GetMessage(900),lpTarget->Name,lpObj->Name);
	...
	//- PK Drop Item System
	if(gServerInfo.m_PkItemDropSwitch == 1 && gServerInfo.m_PkItemDropEnable[lpObj->AccountLevel] == 1 && gServerInfo.m_PkItemDropRate >= rand()%100 && gMapManager.GetMapPkDropItem(lpObj->Map) == 1) //- Add PkDropItem by map Option
	{
		if(lpObj->PKLevel >= 6) //- Fix Pk Item drop to PkLevel 3 only
		{
			count = 24;
...
void gObjUserKill(int aIndex) // OK
{
	...
	{
		lpObj->CloseType = 0;
		//lpObj->CloseCount = 1; //Tempo Relogar ?
...
void gObjSecondProc()
{
	...
	for(n = 0; n < MAX_OBJECT;n++)
	{
		...
		if(lpObj->Connected > OBJECT_LOGGED)
		{
			...
			//Marlon Npc Teleport
			if (lpObj->Type == OBJECT_NPC && lpObj->Class == 229 && gServerInfo.m_NpcMarlonTeleportSwitch == 1)
			{
...
void gObjCheckSelfDefense(LPOBJ lpObj, int aTargetIndex)
{
	...
	lpObj->SelfDefenseTime[blank] = GetTickCount() + gServerInfo.m_SelfDefenseTime;
...
//- Fix ViewPort GuildUnion and Taget Guild Union
int gObjGetRelationShip(LPOBJ lpObj, LPOBJ lpTargetObj)
{
	if ( lpObj == NULL || lpTargetObj == NULL )
	{
