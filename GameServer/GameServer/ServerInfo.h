...
public:
	...
	int m_PKDisableShop; //- Add PK disable shop option
	int m_PKDisableTrade; //- Add PK disable trade option
	int m_TradeSwitch;
	...
	int m_DuelScore; //- Add Duel MaxScore Option
	...
	int m_CashShopWCoinPDelay;
	int m_CashShopWCoinPValue[MAX_ACCOUNT_LEVEL];
	int m_CashShopWCoinCDelay;
	...
	int m_BloodCastleAllowSafeZoneBuff;
	//--
	int m_CustomBloodCastleWindow;
	int m_CustomDevilSquareWindow;
	//--
	int m_BloodCastleMinLvl_1;
	int m_BloodCastleMaxLvl_1;
	int m_BloodCastleMinLvl_2;
	int m_BloodCastleMaxLvl_2;
	int m_BloodCastleMinLvl_3;
	int m_BloodCastleMaxLvl_3;
	int m_BloodCastleMinLvl_4;
	int m_BloodCastleMaxLvl_4;
	int m_BloodCastleMinLvl_5;
	int m_BloodCastleMaxLvl_5;
	int m_BloodCastleMinLvl_6;
	int m_BloodCastleMaxLvl_6;
	int m_BloodCastleMinLvl_7;
	int m_BloodCastleMaxLvl_7;
	int m_BloodCastleMinLvl_8;
	int m_BloodCastleMaxLvl_8;
	//--
	...
	//--
	int m_IllusionTemple2Event;
	int m_IllusionTemple2MinUser;
	int m_IllusionTemple2RewardFenrirRate;
	//--
	...
	int m_SocketSetMixRate[MAX_ACCOUNT_LEVEL];
	//--
	int m_ConquerorWingMixRate[MAX_ACCOUNT_LEVEL];
	//--
	int m_AncientHeroSoulMixRate[MAX_ACCOUNT_LEVEL];
	int m_BloodangelSetMixRate[MAX_ACCOUNT_LEVEL];
	int m_DarkangelSetMixRate[MAX_ACCOUNT_LEVEL];
	int m_HolyangelSetMixRate[MAX_ACCOUNT_LEVEL];
	int m_AwakeningSetMixRate[MAX_ACCOUNT_LEVEL];
	int m_BlueEyeSetMixRate[MAX_ACCOUNT_LEVEL];
	int m_FleetSilverHeartSetMixRate[MAX_ACCOUNT_LEVEL];
	int m_RoaringManticoreSetMixRate[MAX_ACCOUNT_LEVEL];
	//--
	int m_HammerArchangelMixRate[MAX_ACCOUNT_LEVEL];
	int m_AbsoluteArchangelMixRate[MAX_ACCOUNT_LEVEL];
	//--
	int m_DarkangelWeaponMixRate[MAX_ACCOUNT_LEVEL];
	int m_HolyangelWeaponMixRate[MAX_ACCOUNT_LEVEL];
	int m_SoulWeaponMixRate[MAX_ACCOUNT_LEVEL];
	int m_BlueEyeWeaponMixRate[MAX_ACCOUNT_LEVEL];
	int m_SilverHeartWeaponMixRate[MAX_ACCOUNT_LEVEL];
	//--
	int m_SpiritGuardianMixRate[MAX_ACCOUNT_LEVEL];
	int m_DemonMixRate[MAX_ACCOUNT_LEVEL];
	int m_GoldFenrirMixRate[MAX_ACCOUNT_LEVEL];
	//--
	...
	//--
	int m_CommandMasterResetRequiredStr;
	int m_CommandMasterResetRequiredAgi;
	int m_CommandMasterResetRequiredVit;
	int m_CommandMasterResetRequiredEne;
	int m_CommandMasterResetRequiredCom;
	//--
	int m_MaxUserLevel;
	//int m_EnableMaxUserLevel;
	//--
	...
	//--
	int m_CustomArenaNpcEnable; //CustomArenaNpc
	int m_CustomArenaGateIndex0; //GateIndex
	int m_CustomArenaGateIndex1; //GateIndex
	int m_CustomArenaGateIndex2; //GateIndex
	int m_CustomArenaGateIndex3; //GateIndex
	int m_CustomArenaGateIndex4; //GateIndex
	int m_CustomArenaGateIndex5; //GateIndex
	int m_CustomArenaGateIndex6; //GateIndex
	int m_CustomArenaGateIndex7; //GateIndex
	int m_CustomArenaGateIndex8; //GateIndex
	int m_CustomArenaGateIndex9; //GateIndex
	//--
	//--
	int m_CastleSiegeGetCrownUserGuildLevel; //Guild Assistant/Battle Master can get Cs Crown
	int m_CastleSiegeGetCrownTime; //Get Crown Time
	int m_CastleSiegeSeniorMixUnlimitedUse; //Unlock Limit Use SeniorMix
	int m_CastleSiegeResetAccumulationAfterKill; //Reset Acumulation After Kill
	//--
	// REI DO MU
	int m_ReiDoMUEvent;
	int m_ReiDoMUMap;
	...
	//Marlon Teleport
	int m_NpcMarlonTeleportTime;
	int m_NpcMarlonTeleportSwitch;
	int m_NpcMarlonTeleportLog;
	// Monster Die
	int m_DieUserSwitch;
	...
	int m_ComboWithOneSkillEnable;
	int m_ComboWithOneSkillPercent;
	//Start Event
