...
void CServerInfo::ReadCustomInfo() // OK
{
	...
	gPKFree.Load(gPath.GetFullPath("Custom\\CustomPkZone.txt"));

#if (GAMESERVER_CLIENTE_UPDATE >= 14)
	gGiftNew.Load(gPath.GetFullPath("Custom\\CustomStartItem.txt"));
#endif
...
void CServerInfo::ReadMonsterInfo() // OK
{
	...
	gMonsterReward.Load(gPath.GetFullPath("Monster\\MonsterReward.txt"));
...
void CServerInfo::ReadSkillInfo() // OK
{
	...
	if(gServerInfo.m_SkillTreeType == 0 || gServerInfo.m_SkillTreeType == 1)
	{
	...
	{
		gMasterSkillTree.Load(gPath.GetFullPath("Skill\\MasterSkillTreeEx.txt"));
	}
	...
	gCustomDisableSkill.Load(gPath.GetFullPath("Skill\\SkillDisable.txt"));
...
void CServerInfo::ReadCashShopInfo(char* section,char* path) // OK
{
	...
	this->m_CashShopGoblinPointDelay = GetPrivateProfileInt(section,"OnlineRewardGoblinPointDelay",0,path);
	...
	this->m_CashShopWCoinPDelay = GetPrivateProfileInt(section,"OnlineRewardWCoinPDelay",0,path);
	...
	this->m_CashShopWCoinCDelay = GetPrivateProfileInt(section,"OnlineRewardWCoinCDelay",0,path);
...
void CServerInfo::ReadChaosMixInfo(char* section,char* path) // OK
{
	...
	//Pet Mix
	this->m_SpiritGuardianMixRate[0] = GetPrivateProfileInt(section,"SpiritGuardianMixRate_AL0",0,path);

	this->m_SpiritGuardianMixRate[1] = GetPrivateProfileInt(section,"SpiritGuardianMixRate_AL1",0,path);

	this->m_SpiritGuardianMixRate[2] = GetPrivateProfileInt(section,"SpiritGuardianMixRate_AL2",0,path);

	this->m_SpiritGuardianMixRate[3] = GetPrivateProfileInt(section,"SpiritGuardianMixRate_AL3",0,path);

	this->m_DemonMixRate[0] = GetPrivateProfileInt(section,"DemonMixRate_AL0",0,path);

	this->m_DemonMixRate[1] = GetPrivateProfileInt(section,"DemonMixRate_AL1",0,path);

	this->m_DemonMixRate[2] = GetPrivateProfileInt(section,"DemonMixRate_AL2",0,path);

	this->m_DemonMixRate[3] = GetPrivateProfileInt(section,"DemonMixRate_AL3",0,path);

	this->m_GoldFenrirMixRate[0] = GetPrivateProfileInt(section,"GoldFenrirMixRate_AL0",0,path);

	this->m_GoldFenrirMixRate[1] = GetPrivateProfileInt(section,"GoldFenrirMixRate_AL1",0,path);

	this->m_GoldFenrirMixRate[2] = GetPrivateProfileInt(section,"GoldFenrirMixRate_AL2",0,path);

	this->m_GoldFenrirMixRate[3] = GetPrivateProfileInt(section,"GoldFenrirMixRate_AL3",0,path);
	...
	this->m_AncientHeroSoulMixRate[0] = GetPrivateProfileInt(section,"AncientHeroSoulMixRate_AL0",0,path);

	this->m_AncientHeroSoulMixRate[1] = GetPrivateProfileInt(section,"AncientHeroSoulMixRate_AL1",0,path);

	this->m_AncientHeroSoulMixRate[2] = GetPrivateProfileInt(section,"AncientHeroSoulMixRate_AL2",0,path);

	this->m_AncientHeroSoulMixRate[3] = GetPrivateProfileInt(section,"AncientHeroSoulMixRate_AL3",0,path);

	//-> Bloodangel Set Mix

	this->m_BloodangelSetMixRate[0] = GetPrivateProfileInt(section,"BloodangelSetMixRate_AL0",0,path);

	this->m_BloodangelSetMixRate[1] = GetPrivateProfileInt(section,"BloodangelSetMixRate_AL1",0,path);

	this->m_BloodangelSetMixRate[2] = GetPrivateProfileInt(section,"BloodangelSetMixRate_AL2",0,path);

	this->m_BloodangelSetMixRate[3] = GetPrivateProfileInt(section,"BloodangelSetMixRate_AL3",0,path);

	//-> Darkangel Set Mix

	this->m_DarkangelSetMixRate[0] = GetPrivateProfileInt(section,"DarkangelSetMixRate_AL0",0,path);

	this->m_DarkangelSetMixRate[1] = GetPrivateProfileInt(section,"DarkangelSetMixRate_AL1",0,path);

	this->m_DarkangelSetMixRate[2] = GetPrivateProfileInt(section,"DarkangelSetMixRate_AL2",0,path);

	this->m_DarkangelSetMixRate[3] = GetPrivateProfileInt(section,"DarkangelSetMixRate_AL3",0,path);

	//-> Holyangel Set Mix
	
	this->m_HolyangelSetMixRate[0] = GetPrivateProfileInt(section,"HolyangelSetMixRate_AL0",0,path);

	this->m_HolyangelSetMixRate[1] = GetPrivateProfileInt(section,"HolyangelSetMixRate_AL1",0,path);

	this->m_HolyangelSetMixRate[2] = GetPrivateProfileInt(section,"HolyangelSetMixRate_AL2",0,path);

	this->m_HolyangelSetMixRate[3] = GetPrivateProfileInt(section,"HolyangelSetMixRate_AL3",0,path);

	//-> Awakening Set Mix

	this->m_AwakeningSetMixRate[0] = GetPrivateProfileInt(section,"AwakeningSetMixRate_AL0",0,path);

	this->m_AwakeningSetMixRate[1] = GetPrivateProfileInt(section,"AwakeningSetMixRate_AL1",0,path);

	this->m_AwakeningSetMixRate[2] = GetPrivateProfileInt(section,"AwakeningSetMixRate_AL2",0,path);

	this->m_AwakeningSetMixRate[3] = GetPrivateProfileInt(section,"AwakeningSetMixRate_AL3",0,path);

	//-> Blue Eye Set Mix

	this->m_BlueEyeSetMixRate[0] = GetPrivateProfileInt(section,"BlueEyeSetMixRate_AL0",0,path);
			
	this->m_BlueEyeSetMixRate[1] = GetPrivateProfileInt(section,"BlueEyeSetMixRate_AL1",0,path);
			
	this->m_BlueEyeSetMixRate[2] = GetPrivateProfileInt(section,"BlueEyeSetMixRate_AL2",0,path);

	this->m_BlueEyeSetMixRate[3] = GetPrivateProfileInt(section,"BlueEyeSetMixRate_AL3",0,path);

	//-> Fleet Silver Heart Set Mix

	this->m_FleetSilverHeartSetMixRate[0] = GetPrivateProfileInt(section,"FleetSilverHeartSetMixRate_AL0",0,path);
			
	this->m_FleetSilverHeartSetMixRate[1] = GetPrivateProfileInt(section,"FleetSilverHeartSetMixRate_AL1",0,path);
			
	this->m_FleetSilverHeartSetMixRate[2] = GetPrivateProfileInt(section,"FleetSilverHeartSetMixRate_AL2",0,path);

	this->m_FleetSilverHeartSetMixRate[3] = GetPrivateProfileInt(section,"FleetSilverHeartSetMixRate_AL3",0,path);

	//-> Roaring Manticore Set Mix

	this->m_RoaringManticoreSetMixRate[0] = GetPrivateProfileInt(section,"RoaringManticoreSetMixRate_AL0",0,path);
			
	this->m_RoaringManticoreSetMixRate[1] = GetPrivateProfileInt(section,"RoaringManticoreSetMixRate_AL1",0,path);
			
	this->m_RoaringManticoreSetMixRate[2] = GetPrivateProfileInt(section,"RoaringManticoreSetMixRate_AL2",0,path);

	this->m_RoaringManticoreSetMixRate[3] = GetPrivateProfileInt(section,"RoaringManticoreSetMixRate_AL3",0,path);

	//--

	this->m_HammerArchangelMixRate[0] = GetPrivateProfileInt(section,"HammerArchangelMixRate_AL0",0,path);

	this->m_HammerArchangelMixRate[1] = GetPrivateProfileInt(section,"HammerArchangelMixRate_AL1",0,path);

	this->m_HammerArchangelMixRate[2] = GetPrivateProfileInt(section,"HammerArchangelMixRate_AL2",0,path);

	this->m_HammerArchangelMixRate[3] = GetPrivateProfileInt(section,"HammerArchangelMixRate_AL3",0,path);

	//--

	this->m_DarkangelWeaponMixRate[0] = GetPrivateProfileInt(section, "DarkangelWeaponMixRate_AL0", 0, path);

	this->m_DarkangelWeaponMixRate[1] = GetPrivateProfileInt(section, "DarkangelWeaponMixRate_AL1", 0, path);

	this->m_DarkangelWeaponMixRate[2] = GetPrivateProfileInt(section, "DarkangelWeaponMixRate_AL2", 0, path);

	this->m_DarkangelWeaponMixRate[3] = GetPrivateProfileInt(section, "DarkangelWeaponMixRate_AL3", 0, path);

	//--

	this->m_HolyangelWeaponMixRate[0] = GetPrivateProfileInt(section, "HolyangelWeaponMixRate_AL0", 0, path);

	this->m_HolyangelWeaponMixRate[1] = GetPrivateProfileInt(section, "HolyangelWeaponMixRate_AL1", 0, path);

	this->m_HolyangelWeaponMixRate[2] = GetPrivateProfileInt(section, "HolyangelWeaponMixRate_AL2", 0, path);

	this->m_HolyangelWeaponMixRate[3] = GetPrivateProfileInt(section, "HolyangelWeaponMixRate_AL3", 0, path);

	//--

	this->m_SoulWeaponMixRate[0] = GetPrivateProfileInt(section, "SoulWeaponMixRate_AL0", 0, path);

	this->m_SoulWeaponMixRate[1] = GetPrivateProfileInt(section, "SoulWeaponMixRate_AL1", 0, path);

	this->m_SoulWeaponMixRate[2] = GetPrivateProfileInt(section, "SoulWeaponMixRate_AL2", 0, path);

	this->m_SoulWeaponMixRate[3] = GetPrivateProfileInt(section, "SoulWeaponMixRate_AL3", 0, path);

	//--

	this->m_BlueEyeWeaponMixRate[0] = GetPrivateProfileInt(section, "BlueEyeWeaponMixRate_AL0", 0, path);

	this->m_BlueEyeWeaponMixRate[1] = GetPrivateProfileInt(section, "BlueEyeWeaponMixRate_AL1", 0, path);

	this->m_BlueEyeWeaponMixRate[2] = GetPrivateProfileInt(section, "BlueEyeWeaponMixRate_AL2", 0, path);

	this->m_BlueEyeWeaponMixRate[3] = GetPrivateProfileInt(section, "BlueEyeWeaponMixRate_AL3", 0, path);

	//--

	this->m_SilverHeartWeaponMixRate[0] = GetPrivateProfileInt(section, "SilverHeartWeaponMixRate_AL0", 0, path);

	this->m_SilverHeartWeaponMixRate[1] = GetPrivateProfileInt(section, "SilverHeartWeaponMixRate_AL1", 0, path);

	this->m_SilverHeartWeaponMixRate[2] = GetPrivateProfileInt(section, "SilverHeartWeaponMixRate_AL2", 0, path);

	this->m_SilverHeartWeaponMixRate[3] = GetPrivateProfileInt(section, "SilverHeartWeaponMixRate_AL3", 0, path);

	//--

	this->m_AbsoluteArchangelMixRate[0] = GetPrivateProfileInt(section,"BlessedDivineWeaponMixRate_AL0",0,path);

	this->m_AbsoluteArchangelMixRate[1] = GetPrivateProfileInt(section,"BlessedDivineWeaponMixRate_AL1",0,path);

	this->m_AbsoluteArchangelMixRate[2] = GetPrivateProfileInt(section,"BlessedDivineWeaponMixRate_AL2",0,path);

	this->m_AbsoluteArchangelMixRate[3] = GetPrivateProfileInt(section,"BlessedDivineWeaponMixRate_AL3",0,path);

	//--

	this->m_SocketSetMixRate[0] = GetPrivateProfileInt(section, "SocketSetMixRate_AL0", 0, path);

	this->m_SocketSetMixRate[1] = GetPrivateProfileInt(section, "SocketSetMixRate_AL1", 0, path);

	this->m_SocketSetMixRate[2] = GetPrivateProfileInt(section, "SocketSetMixRate_AL2", 0, path);

	this->m_SocketSetMixRate[3] = GetPrivateProfileInt(section, "SocketSetMixRate_AL3", 0, path);
...
void CServerInfo::ReadCharacterInfo(char* section,char* path) // OK
{
	...
	this->m_ComboPushEffect = GetPrivateProfileInt(section,"ComboPushEffect",0,path); //- Combo push effect option
...
void CServerInfo::ReadCommandInfo(char* section,char* path) // OK
{
	...
	this->m_CommandResetKeepDLCommandPoint[0] = GetPrivateProfileInt(section,"CommandResetKeepDLCommandPoint_AL0",0,path);

	this->m_CommandResetKeepDLCommandPoint[1] = GetPrivateProfileInt(section,"CommandResetKeepDLCommandPoint_AL1",0,path);

	this->m_CommandResetKeepDLCommandPoint[2] = GetPrivateProfileInt(section,"CommandResetKeepDLCommandPoint_AL2",0,path);

	this->m_CommandResetKeepDLCommandPoint[3] = GetPrivateProfileInt(section,"CommandResetKeepDLCommandPoint_AL3",0,path);
	...
	this->m_CommandMasterResetRequiredStr = GetPrivateProfileInt(section,"CommandMasterResetRequiredStr",0,path);

	this->m_CommandMasterResetRequiredAgi = GetPrivateProfileInt(section,"CommandMasterResetRequiredAgi",0,path);

	this->m_CommandMasterResetRequiredVit = GetPrivateProfileInt(section,"CommandMasterResetRequiredVit",0,path);

	this->m_CommandMasterResetRequiredEne = GetPrivateProfileInt(section,"CommandMasterResetRequiredEne",0,path);

	this->m_CommandMasterResetRequiredCom = GetPrivateProfileInt(section,"CommandMasterResetRequiredCom",0,path);
	//--
...
void CServerInfo::ReadCommonInfo(char* section,char* path) // OK
{
	...
	this->m_DuelScore = GetPrivateProfileInt(section,"DuelMaxScore",0,path); //- Add Duel MaxScore Option
	...
	//this->m_EnableMaxUserLevel = GetPrivateProfileInt(section, "EnableMaxUserLevel", 1, path);
	...
	this->m_SkillTreeType	= (PROTECT_STATE == 1 && GAMESERVER_CLIENTE_UPDATE >= 2) ? GetPrivateProfileInt(section,"MasterSkillTreeType",0,path): 0;
	...
	//Marlon Teleport
	this->m_NpcMarlonTeleportSwitch = GetPrivateProfileInt(section,"NpcMarlonTeleportSwitch",0,path);
	this->m_NpcMarlonTeleportTime = GetPrivateProfileInt(section,"NpcMarlonTeleportTime",0,path);
	this->m_NpcMarlonTeleportLog = GetPrivateProfileInt(section,"NpcMarlonTeleportLog",0,path);
	...
	//Combo With One Skill
	this->m_ComboWithOneSkillEnable	= (PROTECT_STATE == 1 && GAMESERVER_CLIENTE_UPDATE >= 6) ? GetPrivateProfileInt(section,"ComboWithOneSkillEnable",0,path):0;
	this->m_ComboWithOneSkillPercent	= (PROTECT_STATE == 1 && GAMESERVER_CLIENTE_UPDATE >= 6) ? GetPrivateProfileInt(section,"ComboWithOneSkillPercent",0,path):0;
...
void CServerInfo::ReadCustomInfo(char* section,char* path) // OK
{
	...
	this->m_CustomArenaNpcEnable	= GetPrivateProfileInt(section,"CustomArenaNpcEnable",0,path);
	this->m_CustomArenaGateIndex0	= GetPrivateProfileInt(section,"CustomArenaGateIndex0",0,path);
	this->m_CustomArenaGateIndex1	= GetPrivateProfileInt(section,"CustomArenaGateIndex1",0,path);
	this->m_CustomArenaGateIndex2	= GetPrivateProfileInt(section,"CustomArenaGateIndex2",0,path);
	this->m_CustomArenaGateIndex3	= GetPrivateProfileInt(section,"CustomArenaGateIndex3",0,path);
	this->m_CustomArenaGateIndex4	= GetPrivateProfileInt(section,"CustomArenaGateIndex4",0,path);
	this->m_CustomArenaGateIndex5	= GetPrivateProfileInt(section,"CustomArenaGateIndex5",0,path);
	this->m_CustomArenaGateIndex6	= GetPrivateProfileInt(section,"CustomArenaGateIndex6",0,path);
	this->m_CustomArenaGateIndex7	= GetPrivateProfileInt(section,"CustomArenaGateIndex7",0,path);
	this->m_CustomArenaGateIndex8	= GetPrivateProfileInt(section,"CustomArenaGateIndex8",0,path);
	this->m_CustomArenaGateIndex9	= GetPrivateProfileInt(section,"CustomArenaGateIndex9",0,path);
	...
	this->m_CustomItemStartSwitch[0]	= (PROTECT_STATE == 1 && GAMESERVER_CLIENTE_UPDATE >= 14) ? GetPrivateProfileInt(section,"CustomStartItemSwitch_AL0",0,path): 0;

	this->m_CustomItemStartSwitch[1]	= (PROTECT_STATE == 1 && GAMESERVER_CLIENTE_UPDATE >= 14) ? GetPrivateProfileInt(section,"CustomStartItemSwitch_AL1",0,path): 0;
	
	this->m_CustomItemStartSwitch[2]	= (PROTECT_STATE == 1 && GAMESERVER_CLIENTE_UPDATE >= 14) ? GetPrivateProfileInt(section,"CustomStartItemSwitch_AL2",0,path): 0;

	this->m_CustomItemStartSwitch[3]	= (PROTECT_STATE == 1 && GAMESERVER_CLIENTE_UPDATE >= 14) ? GetPrivateProfileInt(section,"CustomStartItemSwitch_AL3",0,path): 0;
}
...
void CServerInfo::ReadEventInfo(char* section,char* path) // OK
{
	...
	this->m_BloodCastleAllowPk = GetPrivateProfileInt(section,"BloodCastleAllowPk",0,path);

	this->m_BloodCastleAllowSafeZoneBuff = GetPrivateProfileInt(section,"BloodCastleAllowSafeZoneBuff",0,path);

	//--

	this->m_CustomBloodCastleWindow = GetPrivateProfileInt(section,"CustomBloodCastleEventWindow",0,path);

	this->m_CustomDevilSquareWindow = GetPrivateProfileInt(section,"CustomDevilSquareEventWindow",0,path);

	//--

	this->m_BloodCastleMinLvl_1 = GetPrivateProfileInt(section,"BloodCastleMinLevel_1",0,path);

	this->m_BloodCastleMaxLvl_1 = GetPrivateProfileInt(section,"BloodCastleMaxLevel_1",0,path);

	this->m_BloodCastleMinLvl_2 = GetPrivateProfileInt(section,"BloodCastleMinLevel_2",0,path);

	this->m_BloodCastleMaxLvl_2 = GetPrivateProfileInt(section,"BloodCastleMaxLevel_2",0,path);

	this->m_BloodCastleMinLvl_3 = GetPrivateProfileInt(section,"BloodCastleMinLevel_3",0,path);

	this->m_BloodCastleMaxLvl_3 = GetPrivateProfileInt(section,"BloodCastleMaxLevel_3",0,path);

	this->m_BloodCastleMinLvl_4 = GetPrivateProfileInt(section,"BloodCastleMinLevel_4",0,path);

	this->m_BloodCastleMaxLvl_4 = GetPrivateProfileInt(section,"BloodCastleMaxLevel_4",0,path);

	this->m_BloodCastleMinLvl_5 = GetPrivateProfileInt(section,"BloodCastleMinLevel_5",0,path);

	this->m_BloodCastleMaxLvl_5 = GetPrivateProfileInt(section,"BloodCastleMaxLevel_5",0,path);

	this->m_BloodCastleMinLvl_6 = GetPrivateProfileInt(section,"BloodCastleMinLevel_6",0,path);

	this->m_BloodCastleMaxLvl_6 = GetPrivateProfileInt(section,"BloodCastleMaxLevel_6",0,path);

	this->m_BloodCastleMinLvl_7 = GetPrivateProfileInt(section,"BloodCastleMinLevel_7",0,path);

	this->m_BloodCastleMaxLvl_7 = GetPrivateProfileInt(section,"BloodCastleMaxLevel_7",0,path);

	this->m_BloodCastleMinLvl_8 = GetPrivateProfileInt(section,"BloodCastleMinLevel_8",0,path);

	this->m_BloodCastleMaxLvl_8 = GetPrivateProfileInt(section,"BloodCastleMaxLevel_8",0,path);
	...
	this->m_IllusionTemple2Event = GetPrivateProfileInt(section,"IllusionTemple2Event",1,path);

	this->m_IllusionTemple2MinUser = GetPrivateProfileInt(section,"IllusionTemple2MinUser",50,path);

	this->m_IllusionTemple2RewardFenrirRate = GetPrivateProfileInt(section,"IllusionTemple2RewardFenrirRate",0,path);
	...
	this->m_CastleSiegeGetCrownUserGuildLevel = GetPrivateProfileInt(section,"CastleSiegeGetCrownUserGuildLevel",0,path);
	this->m_CastleSiegeGetCrownTime = GetPrivateProfileInt(section,"CastleSiegeGetCrownTime",0,path);
	this->m_CastleSiegeSeniorMixUnlimitedUse = GetPrivateProfileInt(section,"CastleSiegeSeniorMixUnlimitedUse",0,path);
	this->m_CastleSiegeResetAccumulationAfterKill = GetPrivateProfileInt(section, "CastleSiegeResetAccumulationAfterKill", 0, path);
	...
	this->m_RaklionBossEnablePvP			= GetPrivateProfileInt(section,"RaklionBossEnablePvP",0,path);
...
void CServerInfo::ReadHackInfo(char* section,char* path) // OK
{
	...
	this->m_SpeedHackSkillBlockDays = GetPrivateProfileInt(section,"SpeedHackSkillBlockDays",0,path);
