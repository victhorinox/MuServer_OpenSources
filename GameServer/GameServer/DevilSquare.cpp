...
void CDevilSquare::GiveUserRewardItem(DEVIL_SQUARE_LEVEL* lpLevel) // OK
{
	for(int n=0;n < MAX_DS_USER;n++)
	{
		DEVIL_SQUARE_USER* lpUser = this->GetUser(lpLevel,lpLevel->User[n].Index);
		...
		{
			case 0:
				gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DEVIL_SQUARE1,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
				break;
			case 1:
				gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DEVIL_SQUARE2,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
				break;
			case 2:
				gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DEVIL_SQUARE3,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
				break;
			case 3:
				gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DEVIL_SQUARE4,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
				break;
			case 4:
				gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DEVIL_SQUARE5,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
				break;
			case 5:
				gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DEVIL_SQUARE6,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
				break;
			case 6:
				gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DEVIL_SQUARE7,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
				break;
		}
	}
}
