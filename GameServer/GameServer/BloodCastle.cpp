...
int CBloodCastle::GetUserAbleLevel(LPOBJ lpObj) // OK
{
	...
	if(lpObj->Class == CLASS_MG || lpObj->Class == CLASS_DL || lpObj->Class == CLASS_RF)
	{
		if(lpObj->ChangeUp < 2)
		{
			if(lpObj->Level >= gServerInfo.m_BloodCastleMinLvl_1 && lpObj->Level <= gServerInfo.m_BloodCastleMaxLvl_1)
			{
				level = 0;
			}
			else if(lpObj->Level >= gServerInfo.m_BloodCastleMinLvl_2 && lpObj->Level <= gServerInfo.m_BloodCastleMaxLvl_2)
			{
				level = 1;
			}
			else if(lpObj->Level >= gServerInfo.m_BloodCastleMinLvl_3 && lpObj->Level <= gServerInfo.m_BloodCastleMaxLvl_3)
			{
				level = 2;
			}
			else if(lpObj->Level >= gServerInfo.m_BloodCastleMinLvl_4 && lpObj->Level <= gServerInfo.m_BloodCastleMaxLvl_4)
			{
				level = 3;
			}
			else if(lpObj->Level >= gServerInfo.m_BloodCastleMinLvl_5 && lpObj->Level <= gServerInfo.m_BloodCastleMaxLvl_5)
			{
				level = 4;
			}
			else if(lpObj->Level >= gServerInfo.m_BloodCastleMinLvl_6 && lpObj->Level <= gServerInfo.m_BloodCastleMaxLvl_6)
			{
				level = 5;
			}
			else if(lpObj->Level >= gServerInfo.m_BloodCastleMinLvl_7 && lpObj->Level <= gServerInfo.m_BloodCastleMaxLvl_7)
			{
				level = 6;
			}
		}
