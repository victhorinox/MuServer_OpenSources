...
enum eCommandNumber
{
	...
	COMMAND_SET_PK			= 83,
	COMMAND_BLOCK_CHAT		= 84,

	COMMAND_ONLINE			= 85,
	COMMAND_TIME			= 86,
	COMMAND_SET_LEVEL		= 87,
	COMMAND_SET_POINT		= 88,
	COMMAND_SET_STR			= 89,
	COMMAND_SET_AGI			= 90,
	COMMAND_SET_VIT			= 91,
	COMMAND_SET_ENE			= 92,
	COMMAND_SET_CMD			= 93,
	COMMAND_SET_RESET		= 94,
	COMMAND_SET_MRESET		= 95,
	...
	//--
	COMMAND_DROPALL			= 118,
	COMMAND_DROPALL_MAP		= 119,
	COMMAND_MAKEALL			= 120,
	COMMAND_MAKEALL_MAP		= 121,
	
	COMMAND_DROP_FOR		= 122,
	COMMAND_MAKE_FOR		= 123,
	COMMAND_MAKESET_FOR		= 124,
};
...
public:
	...
	bool CommandSetPKLevel(LPOBJ lpObj,char* arg, int Npc);
	bool CommandBlockChat(LPOBJ lpObj,char* arg, int Npc);
	bool CommandOnline(LPOBJ lpObj,char* arg);
	bool CommandTime(LPOBJ lpObj,char* arg);
	bool CommandSetLevel(LPOBJ lpObj,char* arg);
	bool CommandSetLevelUpPoint(LPOBJ lpObj,char* arg);
	bool CommandSetStrength(LPOBJ lpObj,char* arg);
	bool CommandSetAgility(LPOBJ lpObj,char* arg);
	bool CommandSetVitality(LPOBJ lpObj,char* arg);
	bool CommandSetEnergy(LPOBJ lpObj,char* arg);
	bool CommandSetCommand(LPOBJ lpObj,char* arg);
	bool CommandSetResetCount(LPOBJ lpObj,char* arg);
	bool CommandSetMasterResetCount(LPOBJ lpObj,char* arg);
	bool CommandDropAll(LPOBJ lpObj,char* arg);
	bool CommandDropAllMap(LPOBJ lpObj,char* arg);
	bool CommandMakeAll(LPOBJ lpObj,char* arg);
	bool CommandMakeAllMap(LPOBJ lpObj,char* arg);
	bool CommandDropFor(LPOBJ lpObj,char* arg);
	bool CommandMakeFor(LPOBJ lpObj,char* arg);
	bool CommandMakeSetFor(LPOBJ lpObj,char* arg);
private:
