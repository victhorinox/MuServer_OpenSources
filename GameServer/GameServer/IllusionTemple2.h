// IllusionTemple2.h: interface for the CIllusionTemple2 class.
//
//////////////////////////////////////////////////////////////////////
...
class CIllusionTemple2
{
public:
	CIllusionTemple2();
	virtual ~CIllusionTemple2();
	void Init();
	void Load(char* path);
	void MainProc();
	...
	void CGIllusionTemple2EnterRecv(PMSG_ILLUSION_TEMPLE_ENTER_RECV* lpMsg,int aIndex);
	void CGIllusionTemple2SkillRecv(PMSG_ILLUSION_TEMPLE_SKILL_RECV* lpMsg,int aIndex);
	void CGIllusionTemple2ButtonClickRecv(int aIndex);
	void GCIllusionTemple2BattleInfoSend(ILLUSION_TEMPLE_LEVEL* lpLevel);
	void GCIllusionTemple2AddSkillSend(int aIndex,int result,int skill,int bIndex);
	void GCIllusionTemple2RewardScoreSend(ILLUSION_TEMPLE_LEVEL* lpLevel);
	void GCIllusionTemple2KillPointSend(int aIndex,int point);
	void GCIllusionTemple2DelSkillSend(int aIndex,int skill);
	void GCIllusionTemple2EventItemOwnerSend(ILLUSION_TEMPLE_LEVEL* lpLevel);
	void GCIllusionTemple2EventItemOwnerS8Send(ILLUSION_TEMPLE_LEVEL* lpLevel,int Index, int byGet);
	void GCIllusionTemple2ChangeScenarioSend(ILLUSION_TEMPLE_LEVEL* lpLevel,int state,int aIndex);
	void GCIllusionTemple2StoneInfoSend(ILLUSION_TEMPLE_LEVEL* lpLevel,int type,int state);
	void StartIT();
private:
	ILLUSION_TEMPLE_LEVEL m_IllusionTemple2Level[MAX_IT_LEVEL];
	int m_WarningTime;
	int m_NotifyTime;
	int m_EventTime;
	int m_CloseTime;
	std::vector<ILLUSION_TEMPLE_START_TIME> m_IllusionTemple2StartTime;
	int m_IllusionTemple2ExperienceTable[MAX_IT_LEVEL][2];
	int m_IllusionTemple2Reward[MAX_IT_LEVEL][3];
};

extern CIllusionTemple2 gIllusionTemple2;
