...
void CCustomStore::ReadCustomStoreInfo(char* section,char* path) // OK
{
	...
	//GetPrivateProfileString(section,"CustomStoreText12","",this->m_CustomStoreText12,sizeof(this->m_CustomStoreText12),path);

	//GetPrivateProfileString(section,"CustomStoreText13","",this->m_CustomStoreText13,sizeof(this->m_CustomStoreText13),path);
	...
	//GetPrivateProfileString(section,"CustomStoreText10","",this->m_CustomStoreText12,sizeof(this->m_CustomStoreText12),path);

	//GetPrivateProfileString(section,"CustomStoreText11","",this->m_CustomStoreText13,sizeof(this->m_CustomStoreText13),path);
