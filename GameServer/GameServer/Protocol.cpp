	...
	switch(head)
	{
		...
		case 0x79:
			...
			case 0x01:
				...
				//--
				case 0x02:
					gBankEx.SendZenCustomVault(lpObj,"250000000");
					break;
				//--
				case 0x03:
					gBankEx.RecvZenCustomVault(lpObj,"250000000");
					break;
				//--
				case 0x04:
					gBankEx.SendChaosCustomVault(lpObj,"1");
					break;
				case 0x05:
					gBankEx.RecvChaosCustomVault(lpObj,"1");
					break;
				case 0x06:
					gBankEx.SendBlessCustomVault(lpObj,"1");
					break;
				case 0x07:
					gBankEx.RecvBlessCustomVault(lpObj,"1");
					break;
				case 0x08:
					gBankEx.SendSoulCustomVault(lpObj,"1");
					break;
				case 0x09:
					gBankEx.RecvSoulCustomVault(lpObj,"1");
					break;
				case 0x10:
					gBankEx.SendLifeCustomVault(lpObj,"1");
					break;
				case 0x11:
					gBankEx.RecvLifeCustomVault(lpObj,"1");
					break;
				case 0x12:
					gBankEx.SendCreationCustomVault(lpObj,"1");
					break;
				case 0x13:
					gBankEx.RecvCreationCustomVault(lpObj,"1");
					break;
				case 0x14:
					gBankEx.SendHarmonyCustomVault(lpObj,"1");
					break;
				case 0x15:
					gBankEx.RecvHarmonyCustomVault(lpObj,"1");
					break;
				case 0x16:
					gBankEx.SendGuardianCustomVault(lpObj,"1");
					break;
				case 0x17:
					gBankEx.RecvGuardianCustomVault(lpObj,"1");
					break;
				case 0x18:
					gBankEx.SendGemstoneCustomVault(lpObj,"1");
					break;
				case 0x19:
					gBankEx.RecvGemstoneCustomVault(lpObj,"1");
					break;
				case 0x20:
					gBankEx.SendLowerRefinCustomVault(lpObj,"1");
					break;
				case 0x21:
					gBankEx.RecvLowerRefinCustomVault(lpObj,"1");
					break;
				case 0x22:
					gBankEx.SendHighRefinCustomVault(lpObj,"1");
					break;
				case 0x23:
					gBankEx.RecvHighRefinCustomVault(lpObj,"1");
					break;
				//--
			}
			break;
...
void GCAnsCsAccessCrownState(int iIndex, BYTE btCrownState) 
{
	...
	if( btCrownState == 2 )
	{
		...
		if (gObj[iIndex].Live == FALSE)
		{
			...
			if (gServerInfo.m_CastleSiegeResetAccumulationAfterKill == TRUE)
			{
				gObj[iIndex].AccumulatedCrownAccessTime = 0;
			}
